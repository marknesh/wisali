...
<span class="fa fa-star"></span>
        ...
        <div class="property-description"> 
          ...
          <section class="comments margin-top-50">
            ...
            <ul>
              <li>
                ...
                <div class="comment-content">
                  ...
                  <div class="comment-by">Daniel Biden<span class="date">12th, May 2021</span> <a href="#" class="reply"><i class="fa fa-reply"></i> Reply</a> </div>
                ...
                <ul>
                  <li>
                    ...
                    <div class="comment-content">
                      <div class="arrow-comment"></div>
                      <div class="comment-by">Sammy Germaine<span class="date">13th, June 2021</span> <a href="#" class="reply"><i class="fa fa-reply"></i> Reply</a> </div>
                      <p>Lorem Ipsum is simply dummy text of printing and type setting industry. Lorem Ipsum been industry standard dummy text ever since, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="comment-content">
                      <div class="arrow-comment"></div>
                      <div class="comment-by">Humphrey Juma<span class="date">19th, June 2021</span> <a href="#" class="reply"><i class="fa fa-reply"></i> Reply</a> </div>
                      <p>Lorem Ipsum is simply dummy text of printing and type setting industry. Lorem Ipsum been industry standard dummy text ever since, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    </div>
                    <ul>
                      <li>
                        ...
                        <div class="comment-content">
                          <div class="arrow-comment"></div>
                          <div class="comment-by">Eleazer Joseph<span class="date">13th, March 2021</span> <a href="#" class="reply"><i class="fa fa-reply"></i> Reply</a> </div>
                          <p>Lorem Ipsum is simply dummy text of printing and type setting industry. Lorem Ipsum been industry standard dummy text ever since, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                        </div>
                      </li>
                    </ul>
              ...
              <li>
                ...
                <div class="comment-content">
                  <div class="arrow-comment"></div>
                  <div class="comment-by">Esther Evangeline<span class="date">12th, Jan 2020</span> <a href="#" class="reply"><i class="fa fa-reply"></i> Reply</a> </div>
                  <p>Lorem Ipsum is simply dummy text of printing and type setting industry. Lorem Ipsum been industry standard dummy text ever since, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                </div>
              </li>
            </ul>
