        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6">
              {/* Agency */}
              <div className="agent agents-profile agency">
                {" "}
                <a href="/agency-list" className="utf-agent-avatar">
                  {" "}
                ...
                <div className="utf-agent-content">
                  <div className="utf-agent-name">
                    ...
                    <h4>
                      <a href="/agency-list">Modern House Real Estate</a>
                    </h4>
            ...
            <div className="col-md-6">
              ...
              <div className="agent agents-profile agency">
                ...
                <a href="/agency-list" className="utf-agent-avatar">
                  {" "}
                  <img src="images/agency-02.jpg" alt="" />{" "}
                </a>
                <div className="utf-agent-content">
                  <div className="utf-agent-name">
                    <p className="text-alt">Agency</p>
                    ...
                    <h4>
                      <a href="/agency-list">House Real Estate</a>
                    </h4>
                    <ul className="utf-agent-contact-details">
                      <li>
                        <i className="icon-material-outline-business" />
            ...
            <div className="col-md-6">
              ...
              <div className="agent agents-profile agency">
                ...
                <a href="/agency-list" className="utf-agent-avatar">
                  {" "}
                  <img src="images/agency-03.jpg" alt="" />{" "}
                </a>
                <div className="utf-agent-content">
                  <div className="utf-agent-name">
                    <p className="text-alt">Agency</p>
                    ...
                    <h4>
                      <a href="/agency-list">High-Rise Real Estate</a>
                    </h4>
                    <ul className="utf-agent-contact-details">
                      <li>
                        <i className="icon-material-outline-business" />
            ...
            <div className="col-md-6">
              ...
              <div className="agent agents-profile agency">
                ...
                <a href="/agency-list" className="utf-agent-avatar">
                  {" "}
                  <img src="images/agency-04.jpg" alt="" />{" "}
                </a>
                <div className="utf-agent-content">
                  <div className="utf-agent-name">
                    <p className="text-alt">Agency</p>
                    ...
                    <h4>
                      <a href="/agency-list">Country House Real Estate</a>
                    </h4>
                    <ul className="utf-agent-contact-details">
                      <li>
                        <i className="icon-material-outline-business" />
